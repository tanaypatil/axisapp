...
public class Attractions extends AppCompatActivity implements EveList_Adapter.ItemClickCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recView = (RecyclerView)findViewById(R.id.attr_rec);
    ...
    public static List<List_Item> getListData(){
        ...
        String[] titles = {"GUEST LECTURE - AMISH TRIPATHI", "DJ AFISHAL - LIVE CONCERT", "INAUGURATION EVENT"};
