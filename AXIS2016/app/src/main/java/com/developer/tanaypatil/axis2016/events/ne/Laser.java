...
public class Laser extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ne_laser);
        toolbar = (android.support.v7.widget.Toolbar)findViewById(R.id.laser_toolbar);
        setSupportActionBar(toolbar);
        fab = (android.support.design.widget.FloatingActionButton)findViewById(R.id.laserreg);
    ...
    public void onClick(View v) {
        ...
        i.setData(Uri.parse("http://axisvnit.org/events/new/laser.html"));
        startActivity(i);
        */
    }
}
