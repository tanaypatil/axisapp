...
public class Animazione extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sne_animazione);
        toolbar = (android.support.v7.widget.Toolbar)findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        fab = (android.support.design.widget.FloatingActionButton)findViewById(R.id.animreg);
    ...
    public void onClick(View v) {
        ...
        i.setData(Uri.parse("http://axisvnit.org/events/sne/animazion.html"));
        startActivity(i);
        */
    }
}
